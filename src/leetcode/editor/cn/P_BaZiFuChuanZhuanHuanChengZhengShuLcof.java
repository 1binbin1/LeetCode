 ...
 *
 * @author hongxiaobin
 * @date 2023-08-08 20:40:16
 */
public class P_BaZiFuChuanZhuanHuanChengZhengShuLcof {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P_BaZiFuChuanZhuanHuanChengZhengShuLcof().new Solution();
    }
