 ...
 *
 * @author hongxiaobin
 * @date 2023-07-29 22:10:49
 */
public class P_XuanZhuanShuZuDeZuiXiaoShuZiLcof {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P_XuanZhuanShuZuDeZuiXiaoShuZiLcof().new Solution();
    }
